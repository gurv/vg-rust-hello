...
export type Procedures = {
	queries:
		...
		| {
				...
				result: {
					item: Reference<ObjectWithFilePaths2>;
					nodes: CacheNode[];
				} | null;
		  }
		| {
		...
		| {
				key: "labels.getForObject";
				input: LibraryArgs<number>;
				result: Label[];
		  }
		| {
				key: "labels.getWithObjects";
				input: LibraryArgs<number[]>;
				result: {
					[key in number]: {
						date_created: string;
		...
		| {
				key: "labels.listWithThumbnails";
				input: LibraryArgs<string>;
				result: ExplorerItem[];
		  }
		| {
				key: "library.kindStatistics";
				input: LibraryArgs<null>;
				result: KindStatistics;
		  }
		| {
				key: "library.list";
				input: never;
				result: NormalisedResults<LibraryConfigWrapped>;
		  }
		| {
		...
		| {
				...
				input: LibraryArgs<number>;
				result: {
					item: Reference<LocationWithIndexerRule>;
					nodes: CacheNode[];
				} | null;
		  }
		| {
				...
				input: LibraryArgs<number>;
				result: NormalisedResult<IndexerRule>;
		  }
		| {
				key: "locations.indexer_rules.list";
				input: LibraryArgs<null>;
				result: NormalisedResults<IndexerRule>;
		  }
		| {
		...
		| {
				key: "locations.list";
				input: LibraryArgs<null>;
				result: NormalisedResults<Location>;
		  }
		| {
		...
		| {
				...
				input: LibraryArgs<{ filters?: SearchFilterArgs[] }>;
				result: number;
		  }
		| {
				key: "search.paths";
		...
		| {
				key: "tags.get";
				input: LibraryArgs<number>;
				result: { item: Reference<Tag>; nodes: CacheNode[] } | null;
		  }
		| {
				key: "tags.getForObject";
				input: LibraryArgs<number>;
				result: NormalisedResults<Tag>;
		  }
		| {
		...
		| {
				key: "volumes.list";
				input: never;
				result: NormalisedResults<Volume>;
		  };
	mutations:
		...
		| {
				key: "cloud.library.create";
				input: LibraryArgs<null>;
				result: null;
		  }
		| {
				key: "cloud.library.join";
				input: string;
				result: LibraryConfigWrapped;
		  }
		| { key: "cloud.library.sync"; input: LibraryArgs<null>; result: null }
		| {
				key: "cloud.locations.create";
				input: string;
				result: CloudLocation;
		  }
		| {
				key: "cloud.locations.remove";
				input: string;
				result: CloudLocation;
		  }
		...
		| {
				key: "files.copyFiles";
				input: LibraryArgs<OldFileCopierJobInit>;
				result: null;
		  }
		| {
		...
		| {
				key: "files.cutFiles";
				input: LibraryArgs<OldFileCutterJobInit>;
				result: null;
		  }
		| {
				key: "files.deleteFiles";
				input: LibraryArgs<OldFileDeleterJobInit>;
				result: null;
		  }
		| {
				key: "files.eraseFiles";
				input: LibraryArgs<OldFileEraserJobInit>;
				result: null;
		  }
		| {
		...
		| {
				key: "jobs.generateLabelsForLocation";
				input: LibraryArgs<GenerateLabelsForLocationArgs>;
				result: null;
		  }
		| {
		...
		| {
				...
				result: NormalisedResult<LibraryConfigWrapped>;
		  }
		| { key: "library.delete"; input: string; result: null }
		| { key: "library.edit"; input: EditLibraryArgs; result: null }
		| {
				key: "library.startActor";
				input: LibraryArgs<string>;
				result: null;
		  }
		...
		| {
				key: "nodes.updateThumbnailerPreferences";
				input: UpdateThumbnailerPreferences;
				result: null;
		  }
		| {
		...
		| {
				key: "search.saved.delete";
				input: LibraryArgs<number>;
				result: null;
		  }
		| {
				key: "search.saved.update";
				input: LibraryArgs<[number, Args]>;
				result: null;
		  }
		...
		| {
				key: "tags.update";
				input: LibraryArgs<TagUpdateArgs>;
				result: null;
		  }
	...
	subscriptions:
		...
		| {
				...
				result: EphemeralPathsResultItem;
		  }
...
export type CRDTOperationData =
	| "c"
	| { u: { field: string; value: JsonValue } }
	| "d";
...
export type ChangeNodeNameArgs = {
	name: string | null;
	p2p_ipv4_port: Port | null;
	p2p_ipv6_port: Port | null;
	p2p_discovery: P2PDiscoveryState | null;
	image_labeler_version: string | null;
};
...
export type ConvertibleExtension =
	| "bmp"
	| "dib"
	| "ff"
	| "gif"
...
export type CreateLibraryArgs = {
	name: LibraryName;
	default_locations: DefaultLocations | null;
};
...
export type EphemeralPathsResultItem = {
	entries: Reference<ExplorerItem>[];
	errors: Error[];
	nodes: CacheNode[];
};
...
export type EphemeralRenameKind =
...
export type ExplorerItem =
	| { type: "Path"; thumbnail: string[] | null; item: FilePathWithObject }
	| { type: "Object"; thumbnail: string[] | null; item: ObjectWithFilePaths }
...
export type FilePathFilterArgs =
	...
	| { createdAt: Range<string> }
	| { modifiedAt: Range<string> }
	| { indexedAt: Range<string> }
	| { hidden: boolean };
...
export type FullRescanArgs = {
	location_id: number;
	reidentify_objects: boolean;
};

export type GenerateLabelsForLocationArgs = {
	id: number;
	path: string;
	regenerate?: boolean;
};

export type GenerateThumbsForLocationArgs = {
	id: number;
	path: string;
	regenerate?: boolean;
};
...
export type LabelWithObjects = {
	...
	date_created: string | null;
	date_modified: string | null;
	label_objects: { object: { id: number; file_paths: FilePath[] } }[];
};
...
export type LibraryConfig = {
	...
	generate_sync_operations?: boolean;
	version: LibraryConfigVersion;
};

export type LibraryConfigVersion =
	| "V0"
	| "V1"
	| "V2"
	| "V3"
...
export type LibraryPreferences = {
	location?: { [key in string]: LocationSettings };
};
...
export type LocationWithIndexerRule = {
	...
	date_created: string | null;
	instance_id: number | null;
	indexer_rules: Reference<IndexerRule>[];
};
...
export type NodeState = {
	...
	p2p_ipv4_port: Port;
	p2p_ipv6_port: Port;
	p2p_discovery: P2PDiscoveryState;
	features: BackendFeature[];
	preferences: NodePreferences;
	image_labeler_version: string | null;
} & { data_path: string; listeners: Listener2[]; device_model: string | null };
 ...
 * You don't need to use this, it's just a shortcut to avoid having to write out the full type every time.
 */
export type NormalisedResults<T> = {
	items: Reference<T>[];
	nodes: CacheNode[];
};
...
export type ObjectFilterArgs =
	...
	| { kind: InOrNotIn<number> }
	| { tags: InOrNotIn<number> }
	| { labels: InOrNotIn<number> }
	| { dateAccessed: Range<string> };
...
export type ObjectOrder =
	...
	| { field: "mediaData"; value: MediaDataOrder };
...
export type ObjectWithFilePaths2 = {
	id: number;
	pub_id: number[];
	kind: number | null;
	key_id: number | null;
	...
	date_created: string | null;
	date_accessed: string | null;
	file_paths: Reference<FilePath>[];
};

export type OldFileCopierJobInit = {
...
export type OldFileCutterJobInit = {
	source_location_id: number;
	target_location_id: number;
	sources_file_path_ids: number[];
	target_location_relative_directory_path: string;
...
export type OldFileDeleterJobInit = {
	location_id: number;
	file_path_ids: number[];
};

export type OldFileEraserJobInit = {
	location_id: number;
	file_path_ids: number[];
	passes: string;
};
...
export type P2PEvent =
	...
	| { type: "PeerDelete"; identity: RemoteIdentity }
	| {
...
export type PeerMetadata = {
	...
	device_model: HardwareModel | null;
	version: string | null;
};
...
export type ThumbnailerPreferences = {
	background_processing_percentage: number;
};

export type UpdateThumbnailerPreferences = {
	background_processing_percentage: number;
};
